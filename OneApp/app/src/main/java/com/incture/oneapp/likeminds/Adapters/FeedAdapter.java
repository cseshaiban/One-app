...
import com.incture.oneapp.likeminds.CustomViews.ExpandableTextView;
import com.incture.oneapp.likeminds.Data.Feed;
import com.incture.oneapp.likeminds.ProfileViewActivity;
...
//                                ));
    ...
    {
        public  TextView groupName, postDate, author;
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            content = (ExpandableTextView)itemView.findViewById(R.id.group_description);
