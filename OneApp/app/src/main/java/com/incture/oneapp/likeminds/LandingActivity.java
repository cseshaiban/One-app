...
import com.incture.oneapp.leaveapp.activity.Landing_page;
import com.incture.oneapp.likeminds.Adapters.LandingPagerAdapter;
import com.incture.oneapp.tacquisition.MainActivity;
import com.incture.oneapp.timesheet.MainActivity_Timesheet;
        ...
        navigationView.findViewById(R.id.drawer_header).setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("username","Sachin Verma");
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.leave:
                              //  openApp(getApplicationContext(), "com.incture.oneapp.leaveapp.Landing_page");
                                Intent leave = new Intent(LandingActivity.this,Landing_page.class);
                                startActivity(leave);
                                return true;

                            case R.id.timesheet:
                               // openApp(getApplicationContext(), "com.example.arun.timesheet" );
                                Intent sheet = new Intent(LandingActivity.this,MainActivity_Timesheet.class);
                                startActivity(sheet);
                            ...
                            case R.id.talent_acq:
                                ...
                                Intent t = new Intent(LandingActivity.this,MainActivity.class);
                                startActivity(t);
