...
public class MonthView extends AppCompatActivity {
        ...
        nav.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                if (menuItem.getItemId() == R.id.history) {
                    ...
                    Intent intent = new Intent(MonthView.this, Months.class);
                    startActivity(intent);

                } else {
                    mDrawerLayout = (DrawerLayout) findViewById(R.id.drawer_layout);
                    mDrawerLayout.closeDrawers();
                    Intent intent = new Intent(MonthView.this, MainActivity_Timesheet.class);
                    startActivity(intent);
    ...
    private void setuptoolbar() {
        ...
        getSupportActionBar().setTitle("Month View");
    }
